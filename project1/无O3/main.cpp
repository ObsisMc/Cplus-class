...
int main()
{
    ...
    cout << "pack (1D-array matrix): " << time1_pack << endl;
    cout << endl;

    double time1 = matrix1DTime(A1, B1, C1);//一维C中元素一个一个计算
    cout << "original (1D-array matrix): " << time1 << endl;
    cout << endl;
    // showMatrix1D(C1);
    // cout<<endl;
    resetMatrix1D(C1);
    ...
    cout << "Change order of calc (1D-array matrix): " << time1_2 << endl;
    cout << endl;
    // showMatrix1D(C1);
    // cout<<endl;
    resetMatrix1D(C1);
    ...
    cout << "Change order of calc-Gap4 (1D-array matrix): " << time1_3 << endl;
    cout << endl;
    // showMatrix1D(C1);
    // cout<<endl;
    resetMatrix1D(C1);
    ...
    cout << "change order-gap8 (1D-array matrix): " << time1_3_gap8 << endl;
    cout << endl;

    double time1_tran = matrix1DTime_Tran(A1, B1, C1);//一维B转置再相乘
    cout << "transpose (1D-array matrix): " << time1_tran << endl;
    // showMatrix1D(C1);
    // cout<<endl;
    cout << endl;
    resetMatrix1D(C1);
    ...
    cout << "mm256 (1D-array matrix): " << time1_mm256 << endl;
    cout << endl;

    double time1_gap = matrix1DTime_Gap(A1, B1, C1);//一维循环展开8
    cout << "Gap 8 (2D-array matrix): " << time1_gap << endl;
    cout << endl;
    resetMatrix1D(C1);

    double time1_para = matrix1DTime_Para(A1, B1, C1);//一维omp
    cout << "parallel (1D-array matrix): " << time1_para << endl;
    cout << endl;
    // showMatrix1D(C1);
    // cout<<endl;
    resetMatrix1D(C1);
    ...
    cout << "original (2D-array matrix): " << time2 << endl;
    cout << endl;

    double time2_2 = matrix2DTime_2(A2, B2, C2);//二维C中元素一行一行计算
    cout << "Change order of calc (2D-array matrix): " << time2_2 << endl;
    cout << endl;

    double time2_gap = matrix2DTime_Gap(A2, B2, C2);//二维循环展开8
    cout << "Gap 8 (2D-array matrix): " << time2_gap << endl;
}
