...
long double dotProduct(float *f1, float *f2, long long len);        //读文件的计算
long double result(float f1, float f2, long double sum);
void branchProduct1(vector<float> v[], long long begin, long long end, long double &sum);
void branchProduct2(float *f1, float *f2, long long begin, long long end, long double &sum);
...
long double dotProduct(vector<float> v[])
{
    ...
    if (len >= 1000000)
    {
        ...
        thread first(branchProduct1, ref(v), 0, ref(p1e), ref(sum));
        thread second(branchProduct1, ref(v), ref(p1e), ref(p2e), ref(sum));
        thread third(branchProduct1, ref(v), ref(p2e), ref(p3e), ref(sum));
        thread forth(branchProduct1, ref(v), ref(p3e), ref(p4e), ref(sum));
        thread fifth(branchProduct1, ref(v), ref(p4e), ref(p5e), ref(sum));
